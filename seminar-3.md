...
1. Придумываем вопросы с ответами разных типов \(помним, что вашим друзьям нужно будет отвечать на эти вопросы, причем честно\). Чтобы добавить новый вопрос, нажимаем плюсик справа:

2. Также обращаем внимание, что добавить можно не только новый вопрос, но и, например, картинку \(к текущему вопросу\). Пробуем!

3. Замечаем, что вопросы могут быть обязательные или необязательные, что к каждому вопросу можно добавить комментарий \(описание\), а также удалить или дублировать вопрос. Пробуем всё это!
